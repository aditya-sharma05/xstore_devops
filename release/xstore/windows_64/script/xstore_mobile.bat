...
set OS_ADDITIONAL_PROP_1=wrapper.java.additional.96=-Dlog.dir.name=../xstoredata/xstore/log/xstore_mobile
...
if "%COMMAND%" == "" (
    ...
    echo     %0 start      start Xstore Mobile Server once installed as a Windows service
    echo     %0 restart    restart Xstore Mobile Server once installed as a Windows service
    echo     %0 stop       stop Xstore Mobile Server once installed as a Windows service
    echo     %0 install    install Xstore Mobile Server as a Windows service
    echo     %0 remove     uninstall Xstore Mobile Server as a Windows service
...
:console
SET my_title=Xstore Mobile Server Console (%RANDOM%)
