...
APP_LONG_NAME="Xstore Mobile Server"
...
# description: Xstore Mobile Server
...
OS_ADDITIONAL_PROP_1=wrapper.java.additional.96=-Dlog.dir.name=../xstoredata/xstore/log/xstore_mobile
