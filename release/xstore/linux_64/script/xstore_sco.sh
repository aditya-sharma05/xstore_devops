...
# Application
APP_NAME="xstore_sco"
APP_LONG_NAME="Xstore Self Checkout POS"
...
# description: Xstore Self Checkout POS
...
WRAPPER_CONF=$REALPATH/wrapper/conf/xstore_sco.conf
APPLICATION_DIRECTORY="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
export PLATFORM=linux_64
export _WRAPPED_APP=xstore_sco
export JAVA_HOME=$(cd "${APPLICATION_DIRECTORY}/../jre" && pwd)
export JAVA=$JAVA_HOME/bin/xstore_sco
PLATFORMPATH=$REALPATH/$PLATFORM
OS_ADDITIONAL_PROP_1=wrapper.java.additional.96=-Dlog.dir.name=../xstoredata/xstore/log/xstore_sco
...
WRAPPER_CMD=$PLATFORMPATH/bin/xstore_sco-wrapper
