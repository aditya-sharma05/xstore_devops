...
BEGIN
  ALTER TABLE dat_legal_entity_change ADD company_business_name varchar(254) NULL;
...
BEGIN
  ALTER TABLE dat_emp_change ADD marital_status varchar(30) NULL;
...
BEGIN
  ALTER TABLE dat_emp_change ADD spouse_name varchar(254) NULL;
...
BEGIN
  ALTER TABLE dat_emp_change ADD employee_role_code varchar(30) NULL;
...
BEGIN
  ALTER TABLE dat_emp_change ADD employee_group_id varchar(60) NULL;
...
BEGIN
  ALTER TABLE dat_emp_change ADD social_security_nbr varchar(255) NULL;
...
BEGIN
  ALTER TABLE dat_emp_change ADD national_tax_id varchar(30) NULL;
...
BEGIN
  ALTER TABLE dat_emp_change ADD personal_tax_id varchar(30) NULL;
...
-- [RXPS-63846] START
    ...
    BEGIN
      ...
      ALTER TABLE CFG_INTEGRATION ALTER COLUMN INTEGRATION_SYSTEM VARCHAR(50) NOT NULL;
...
GO
    ...
    BEGIN
      ...
      ALTER TABLE CFG_INTEGRATION_P ALTER COLUMN INTEGRATION_SYSTEM VARCHAR(50) NOT NULL;
...
exec('CREATE TABLE [dbo].[cfg_attachment_types](
    [attachment_type_id]    varchar(30)     NOT NULL,
