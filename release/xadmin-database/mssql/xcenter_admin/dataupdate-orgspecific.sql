...
INSERT INTO cfg_tender_type_category(organization_id, tender_category, tender_type, create_date, create_user_id) values ($(OrgID), 'AUTHORIZATION', 'PAY_BY_LINK', getDate(), 'BASEDATA');
INSERT INTO cfg_tender_type_category(organization_id, tender_category, tender_type, create_date, create_user_id) values ($(OrgID), 'AUTHORIZATION', 'MISCELLANEOUS_EFTLINK', getDate(), 'BASEDATA');
INSERT INTO cfg_tender_type_category(organization_id, tender_category, tender_type, create_date, create_user_id) values ($(OrgID), 'AUTHORIZATION', 'EWALLET', getDate(), 'BASEDATA');
GO
...
INSERT INTO cfg_tender_type_category(organization_id, tender_category, tender_type, create_date, create_user_id) values ($(OrgID), 'COUNT', 'PAY_BY_LINK', getDate(), 'BASEDATA');
INSERT INTO cfg_tender_type_category(organization_id, tender_category, tender_type, create_date, create_user_id) values ($(OrgID), 'COUNT', 'MISCELLANEOUS_EFTLINK', getDate(), 'BASEDATA');
INSERT INTO cfg_tender_type_category(organization_id, tender_category, tender_type, create_date, create_user_id) values ($(OrgID), 'COUNT', 'EWALLET', getDate(), 'BASEDATA');
...
INSERT INTO cfg_reason_code_type (organization_id, reason_code_type, description, create_date, create_user_id) VALUES ($(OrgID), 'ORDER_CANCEL_BACKOFFICE', '_reasonCodeType_ORDER_CANCEL_BACKOFFICE', getDate(), 'BASEDATA');
...
INSERT INTO ocds_subtask_details (organization_id, subtask_id, filename_prefix, query_by_chain, query_by_org_node, destination, download_time, apply_immediately, family, path, create_date, create_user_id) VALUES ($(OrgID), 'PRICE', '5_price', '0', '1', 'ALL', 'IMMEDIATE','1', 'PRICE', '/v2/item/price?pricetype=INITIAL', getDate(), 'BASEDATA');
END

IF NOT EXISTS (SELECT 1 FROM ocds_subtask_details where subtask_id = 'REGULAR_PRICE_CHANGE' and organization_id = $(OrgID))
BEGIN

INSERT INTO ocds_subtask_details (organization_id, subtask_id, filename_prefix, query_by_chain, query_by_org_node, destination, download_time, apply_immediately, family, path, create_date, create_user_id) VALUES ($(OrgID), 'REGULAR_PRICE_CHANGE', '5_regpc', '0', '1', 'ALL', 'IMMEDIATE','1', 'PRICE', '/v2/item/price?pricetype=REGULAR', getDate(), 'BASEDATA');
END

IF NOT EXISTS (SELECT 1 FROM ocds_subtask_details where subtask_id = 'CLEARANCE_PRICE_CHANGE' and organization_id = $(OrgID))
BEGIN

INSERT INTO ocds_subtask_details (organization_id, subtask_id, filename_prefix, query_by_chain, query_by_org_node, destination, download_time, apply_immediately, family, path, create_date, create_user_id) VALUES ($(OrgID), 'CLEARANCE_PRICE_CHANGE', '5_clrpc', '0', '1', 'ALL', 'IMMEDIATE','1', 'PRICE', '/v2/item/price?pricetype=CLEARANCE', getDate(), 'BASEDATA');
END
...
GO
  ...
  SELECT $(OrgID), 'ADMINISTRATOR', privilege_id, getDate(), 'BASEDATA' FROM cfg_privilege WHERE privilege_id NOT IN ('ADMN_STORE_AUTH_MANAGER','ADMN_STORE_ENROLL', 'ADMN_XOFFICE_CS_STORE_ENROLL', 'ADMN_CREDENTIALS_STORAGE');
GO
