...
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('idcs/relate', 'Use Identity Provider for Authorization', 'relate', 20, getDate(), 'BASEDATA');
...
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('idcs/locate', 'Use Identity Provider for Authorization', 'order:locate', 10, getDate(), 'BASEDATA');
...
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('idcs/serenade', 'Use Identity Provider for Authorization', 'crosschannelreturn:serenade', 10, getDate(), 'BASEDATA');
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('sim:sim/$FORM_FACTOR$', 'Store Inventory Operations Cloud Service', null, 50, getDate(), 'BASEDATA');
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('idcs/sim', 'Use Identity Provider for Authorization', 'sim:sim/$FORM_FACTOR$', 10, getDate(), 'BASEDATA');
...
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('avs', 'Address Verification', null, 70, getDate(), 'BASEDATA');
...
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('paybylink', 'Payment By Link Tenders', null, 130, getDate(), 'BASEDATA');
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('24x7', '24 x 7 Support (No Store Closing)', null, 140, getDate(), 'BASEDATA');
...
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('invoice/globalblue', 'Global Blue Tax Free (cannot be combined with Planet Tax Free)', 'invoice', 10, getDate(), 'BASEDATA');
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('invoice/fintrax', 'Planet Tax Free (cannot be combined with Global Blue Tax Free)', 'invoice', 20, getDate(), 'BASEDATA');
...
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('enhancedemail', 'Enhanced Email Receipts', null, 210, getDate(), 'BASEDATA');
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('qas/addressmanual', 'Experian Address Verification (Manual)', 'avs', 200, getDate(), 'BASEDATA');
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('qas/addressauto', 'Experian Address Verification (Auto)', 'avs', 200, getDate(), 'BASEDATA');
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('qas/email', 'Experian Email Address Verification', 'avs', 200, getDate(), 'BASEDATA');
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('qas/phone', 'Experian Phone Number Verification', 'avs', 200, getDate(), 'BASEDATA');
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('promote', 'Promotions Engine', 'relate', 30, getDate(), 'BASEDATA');
INSERT INTO cfg_base_feature (feature_id, description, depends_on_feature_id, sort_order, create_date, create_user_id) VALUES ('extensionstore', 'Extension Store', null, 220, getDate(), 'BASEDATA');
GO
...
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('Administration', 'ADMN_BROADCASTERS', 'Broadcasters', 'Broadcasters', getDate(), 'BASEDATA');
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('Administration', 'ADMN_INTEGRATIONS', 'Integrations', 'Integrations', getDate(), 'BASEDATA');
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('Administration', 'ADMN_ATTACHMENTS', 'Attachments', 'Attachments', getDate(), 'BASEDATA');
...
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('Administration', 'ADMN_PBL_SETUP', 'Setup Pay By Link', 'Setup Pay By Link', getDate(), 'BASEDATA');
...
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('DataManager', 'CFG_HIERARCHY_MANAGER', 'Hierarchy Manager', 'Hierarchy Manager', getDate(), 'BASEDATA');
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('DataManager', 'CFG_MERCHANDISE_HIERARCHY', 'Merchandise Hierarchy', 'Merchandise Hierarchy', getDate(), 'BASEDATA');
...
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('DataManager', 'CFG_MERCH_HIERARCHY_MAINT', 'Merchandise Hierarchy Maintenance', 'Merchandise Hierarchy Maintenance', getDate(), 'BASEDATA');
...
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('DataManager', 'CFG_OCDS_DATA_REFRESH', 'Merchandise Data Refresh', 'Merchandise Data Refresh', getDate(), 'BASEDATA');
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('DataManager', 'CFG_AVATAX_DATA_REFRESH', 'Avalara Tax Data Refresh', 'AvaTax Data Refresh', getDate(), 'BASEDATA');
...
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('Reports', 'RPT_REGISTER_COUNT', 'Register Count Report', 'Register Count Report', getDate(), 'BASEDATA');
...
INSERT INTO cfg_privilege (category, privilege_id, privilege_desc, short_desc, create_date, create_user_id) VALUES ('Reports', 'RPT_SALES_DEPARTMENT', 'Sales Overview Report', 'Sales Overview Report', getDate(), 'BASEDATA');
...
VALUES ('MAIN_MENU', 'BROADCASTERS', 'SYSTEM_MANAGER2_FEATURE', 'BROADCASTERS', '_broadcastersFeatureTitle', 40, 1, 'ADMN_BROADCASTERS', '/xadmin/images/sysmanager/broadcasters.png', '_broadcastersMaintDesc', getDate(), 'BASEDATA');
GO
...
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, config_type, title, sort_order, active_flag, security_privilege, menu_small_icon, description, create_date, create_user_id)
VALUES ('MAIN_MENU', 'INTEGRATIONS', 'SYSTEM_MANAGER2_FEATURE', 'INTEGRATIONS', '_integrationsFeatureTitle', 50, 1, 'ADMN_INTEGRATIONS', '/xadmin/images/sysmanager/integrations.png', '_integrationsMaintDesc', getDate(), 'BASEDATA');
GO
...
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, config_type, title, sort_order, active_flag, security_privilege, menu_small_icon, description, create_date, create_user_id)
VALUES ('MAIN_MENU', 'ATTACHMENTS', 'SYSTEM_MANAGER2_FEATURE', 'ATTACHMENTS', '_attachmentsFeatureTitle', 60, 1, 'ADMN_ATTACHMENTS', '/xadmin/images/sysmanager/attachments.png', '_attachmentsMaintDesc', getDate(), 'BASEDATA');
GO
...
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, title, sort_order, active_flag, security_privilege, create_date, create_user_id)
  VALUES ('MAIN_MENU', 'HIERARCHY_MANAGER', 'DATA_MANAGER_MENU', '_hierarchyManagerTitle', 10, 1, 'CFG_HIERARCHY_MANAGER', getDate(), 'BASEDATA');
GO
...
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, config_type, title, sort_order, active_flag, security_privilege, menu_small_icon, description, create_date, create_user_id)
  VALUES ('MAIN_MENU', 'AVA_TAXES', 'DATA_MANAGER4_FEATURE', 'AVA_TAXES', '_avalaraTaxesConfigFeatureTitle', 30, 1, 'CFG_AVATAX_DATA_REFRESH', '/xadmin/images/datamanager/Taxes6464.png', '_avaTaxesMaintDesc', getDate(), 'BASEDATA');
...
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, config_type, title, sort_order, active_flag, security_privilege, menu_small_icon, description, create_date, create_user_id)
  VALUES ('MAIN_MENU', 'SETUP_PBL', 'SYSTEM_MANAGER2_FEATURE', 'PAYMENT', '_pblSetupTitle', 30, 1, 'ADMN_PBL_SETUP', '/xadmin/images/sysmanager/paybylink.png', '_pblSetupDesc', getDate(), 'BASEDATA');
GO
...
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, config_type, title, sort_order, action_expression, active_flag, security_privilege, description, create_date, create_user_id)
  VALUES ('REPORT_VIEWER_MENU', 'SALES_BY_MERCHLVL1_REPORT', 'SALES_GROUP', 'REPORTS', '_rptSalesByMerchLevel1TitleMenu', 40, '@{reportLoadAction.execute(''SALES_BY_MERCHLVL1_REPORT'')}', 1, 'RPT_SALES_DEPARTMENT', '_rptDescSalesOverview', getDate(), 'BASEDATA');
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, config_type, title, sort_order, action_expression, active_flag, security_privilege, description, create_date, create_user_id)
...
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, config_type, title, sort_order, action_expression, active_flag, security_privilege, description, create_date, create_user_id)
  VALUES ('REPORT_VIEWER_MENU', 'DAILY_SALES_REPORT', 'SALES_GROUP', 'REPORTS', '_rptDailySalesReportTitleMenu', 130, '@{reportLoadAction.execute(''DAILY_SALES_REPORT'')}', 1, 'RPT_DAILY_SALES', '_rptDescDailySalesTotal', getDate(), 'BASEDATA');
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, config_type, title, sort_order, action_expression, active_flag, security_privilege, description, create_date, create_user_id)
...
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, config_type, title, sort_order, action_expression, active_flag, security_privilege, description, create_date, create_user_id)
  VALUES ('REPORT_VIEWER_MENU', 'REGISTER_COUNT_REPORT', 'MISC_GROUP', 'REPORTS', '_rptRegisterCountReport', 60, '@{reportLoadAction.execute(''REGISTER_COUNT_REPORT'')}', 1, 'RPT_REGISTER_COUNT', '_rptDescRegisterCount', getDate(), 'BASEDATA');
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, config_type, title, sort_order, action_expression, active_flag, security_privilege, description, create_date, create_user_id)
...
INSERT INTO cfg_menu_config (category, menu_name, parent_menu_name, title, sort_order, active_flag, security_privilege, create_date, create_user_id)
  VALUES ('HOME_PAGE_MENU', 'HIERARCHY_MANAGER', 'DATA_OPTIONS', '_hierarchyManagerTitle', 20, 1, 'CFG_HIERARCHY_MANAGER', getDate(), 'BASEDATA');
GO
...
INSERT INTO cfg_code_value (category, config_name, code, sub_category, description, sort_order, create_date, create_user_id)
  VALUES ('DATA', 'AUTH_METHOD_CODE', 'EFT_LINK_PBL', 'DEFAULT', '_EFT_LINK_PBL', 130, getDate(), 'BASEDATA');
INSERT INTO cfg_code_value (category, config_name, code, sub_category, description, sort_order, create_date, create_user_id)
  VALUES ('DATA', 'AUTH_METHOD_CODE', 'EFT_LINK_PBL_CNP', 'DEFAULT', '_EFT_LINK_PBL_CNP', 130, getDate(), 'BASEDATA');
INSERT INTO cfg_code_value (category, config_name, code, sub_category, description, sort_order, create_date, create_user_id)
  VALUES ('DATA', 'AUTH_METHOD_CODE', 'EFTLINK_MOBILE_RECHARGE', 'DEFAULT', '_EFTLINK_MOBILE_RECHARGE', 130, getDate(), 'BASEDATA');
INSERT INTO cfg_code_value (category, config_name, code, sub_category, description, sort_order, create_date, create_user_id)
  VALUES ('DATA', 'AUTH_METHOD_CODE', 'EFTLINK_INVOICE_PAYMENT', 'DEFAULT', '_EFTLINK_INVOICE_PAYMENT', 130, getDate(), 'BASEDATA');  
INSERT INTO cfg_code_value (category, config_name, code, sub_category, description, sort_order, create_date, create_user_id)
...
IF NOT EXISTS (SELECT 1 FROM cfg_system_setting where config_id = 'DaysBeforePurgeServiceResponseLogs')
BEGIN

INSERT INTO cfg_system_setting (config_id, config_value, modified_event, create_user_id, create_date)
  VALUES ('DaysBeforePurgeServiceResponseLogs', '30', 'com.micros_retail.configurator.purge.daysBeforePurgeServiceResponseLogsChanged', 'BASEDATA', getDate());
END
...
IF NOT EXISTS (SELECT 1 FROM cfg_system_setting where config_id = 'BrNFEExportEnabled')
BEGIN

INSERT INTO cfg_system_setting (config_id, config_value, modified_event, create_user_id, create_date)
  VALUES ('BrNFEExportEnabled', 'false', null, 'BASEDATA', getDate());
END

IF NOT EXISTS (SELECT 1 FROM cfg_system_setting where config_id = 'BrNFEExportJobStartTime')
BEGIN

INSERT INTO cfg_system_setting (config_id, config_value, modified_event, create_user_id, create_date)
  VALUES ('BrNFEExportJobStartTime', '06:00', null, 'BASEDATA', getDate());
END

IF NOT EXISTS (SELECT 1 FROM cfg_system_setting where config_id = 'ItalyInvoiceExportEnabled')
BEGIN

INSERT INTO cfg_system_setting (config_id, config_value, modified_event, create_user_id, create_date)
  VALUES ('ItalyInvoiceExportEnabled', 'false', null, 'BASEDATA', getDate());
END

IF NOT EXISTS (SELECT 1 FROM cfg_system_setting where config_id = 'ItalyInvoiceExportJobStartTime')
BEGIN

INSERT INTO cfg_system_setting (config_id, config_value, modified_event, create_user_id, create_date)
  VALUES ('ItalyInvoiceExportJobStartTime', '06:00', null, 'BASEDATA', getDate());
END
...
INSERT INTO cfg_system_setting (config_id, config_value, modified_event, create_user_id, create_date)
  VALUES ('DaysBeforePurgeCountryFRArchives', '-1', 'com.micros_retail.configurator.purge.daysBeforePurgeCountryFRArchives', 'BASEDATA', getDate());
END

IF NOT EXISTS (SELECT 1 FROM cfg_system_setting where config_id = 'DaysBeforePurgeCountryBRNfe')
BEGIN

INSERT INTO cfg_system_setting (config_id, config_value, modified_event, create_user_id, create_date)
  VALUES ('DaysBeforePurgeCountryBRNfe', '-1', 'com.micros_retail.configurator.purge.daysBeforePurgeCountryBRNfe', 'BASEDATA', getDate());
END

IF NOT EXISTS (SELECT 1 FROM cfg_system_setting where config_id = 'DaysBeforePurgeCountryPTAts')
BEGIN

INSERT INTO cfg_system_setting (config_id, config_value, modified_event, create_user_id, create_date)
  VALUES ('DaysBeforePurgeCountryPTAts', '-1', 'com.micros_retail.configurator.purge.daysBeforePurgeCountryPTAts', 'BASEDATA', getDate());
END
...
INSERT INTO cfg_attachment_types(attachment_type_id, description, create_date, create_user_id)
  VALUES('TSE_STORAGE_BYTES', '_tseStorageBytes' , getDate(), 'BASEDATA');
INSERT INTO cfg_attachment_types(attachment_type_id, description, create_date, create_user_id)
  VALUES('INVOICE_RESPONSE', '_invoiceResponse' , getDate(), 'BASEDATA');
INSERT INTO cfg_attachment_types(attachment_type_id, description, create_date, create_user_id)
  VALUES('INVOICE_PAYLOAD', '_invoicePayload' , getDate(), 'BASEDATA');
INSERT INTO cfg_attachment_types(attachment_type_id, description, create_date, create_user_id)
  VALUES('ERECEIPT_PAYLOAD', '_ereceiptPayload' , getDate(), 'BASEDATA');
INSERT INTO cfg_attachment_types(attachment_type_id, description, create_date, create_user_id)
  VALUES('ERECEIPT_RESPONSE', '_ereceiptResponse' , getDate(), 'BASEDATA');
INSERT INTO cfg_attachment_types(attachment_type_id, description, create_date, create_user_id)
  VALUES('MX_INVOICE', '_mxInvoice' , getDate(), 'BASEDATA');
INSERT INTO cfg_attachment_types(attachment_type_id, description, create_date, create_user_id)
  VALUES('MX_PENDING_GLOBAL_INVOICES', '_mxPendingGlobalInvoices' , getDate(), 'BASEDATA');
INSERT INTO cfg_attachment_types(attachment_type_id, description, create_date, create_user_id)
  VALUES('CSV', '_csv' , getDate(), 'BASEDATA');
INSERT INTO cfg_attachment_types(attachment_type_id, description, create_date, create_user_id)
  VALUES('DSFINVK_STORAGE_BYTES', '_dsfinvkStorageBytes' , getDate(), 'BASEDATA');
  INSERT INTO cfg_attachment_types(attachment_type_id, description, create_date, create_user_id)
  VALUES('FRA_ARCHIVE', '_fraArchive' , getDate(), 'BASEDATA');
